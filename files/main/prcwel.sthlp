...
gen pc_rice = -0.06 ;
gen pc_other = 0.05 ;
prcwel pc_income, hsize(hhsize) pline(pline) meas(2) sotm(2) inisave(example4) gvimp(0) nitems(4) matpel(elas_price) matiel(elas_income) 
it1( sn(Corn) it(pc_exp_corn) prc(pc_corn) ) 
it2( sn(Wheat) it(pc_exp_wheat) prc(pc_wheat) ) 
it3( sn(Rice) it(pc_exp_rice) prc(pc_rice) ) 
it4( sn(Other_Cereals) it(pc_exp_other) prc(pc_other) ) 
xfil(myexample4)   
;
