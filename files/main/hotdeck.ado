...
qui sort `tempid' , stable
end

/*************************************************
 * Expand stata syntax
 *************************************************/
cap program drop mkvlist
