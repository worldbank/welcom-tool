...
basicratio `asliving' `pcexp',  hsize1(`_ths') hsize2(`_ths')  p1(0.1) p2(0.9);
};
if (`move'==-1)     {; 
tempvar sliving asliving osliving;
qui gen `sliving' = `pcexp'+ `total';
...
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
gen `osliving' = `asliving' ;
basicratio `pcexp' `asliving', hsize1(`_ths') hsize2(`_ths')  p1(0.1) p2(0.9);
};
...
qui gen `asliving' = `sliving';
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
if (`move'== 1)   basicratio `asliving' `osliving', hsize1(`_ths') hsize2(`_ths')  p1(0.1) p2(0.9);
if (`move'==-1)   basicratio `asliving' `pcexp' ,   hsize1(`_ths') hsize2(`_ths')  p1(0.1) p2(0.9);
...
qui gen `asliving' = `sliving';
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
basicratio `pcexp' `osliving',  hsize1(`_ths') hsize2(`_ths')   p1(0.1) p2(0.9);
};
