...
#delimit;
capture program drop prjob44;
program define prjob44, eclass;
version 9.2;
...
prjobstat `tot_imp',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(total)   stat(exp_pcs3) pcexp(`pcexp');  ;
tempname mat44tot ;
...
prjobstat `flist',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(`slist')   stat(exp_pcs3) pcexp(`pcexp');  ;
cap drop `drlist';
tempname mat44 ;
matrix `mat44'= e(est);
