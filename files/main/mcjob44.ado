...
cap drop  __imwmc;
mcjobstat `tot_imp',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(total)   stat(exp_pcs2) pcexp(`pcexp') tpop(1) rtit(1)  ;
tempname mat44tot ;
matrix `mat44tot'= e(est); 
};
...
mcjobstat `flist',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(`slist')   stat(exp_pcs2) pcexp(`pcexp') tpop(1) rtit(1)  ;
cap drop `drlist';
tempname mat44 ;
matrix `mat44'= e(est);
