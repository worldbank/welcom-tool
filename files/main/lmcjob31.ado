...
#delimit;
capture program drop lmcjob31;
program define lmcjob31, eclass;
version 9.2;
...
lmcjobstat `flist',    hgroup(`hgroup') lan(`lan')   xrnames(`slist') pcexp(`pcexp')  stat(exp_pc) rtot(Population) ctot(All sectors) ;
cap drop `drlist';
tempname mat31 ;
matrix `mat31'= e(est);
