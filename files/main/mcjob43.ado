...
mcjobstat `tot_imp',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(total)  stat(share_tot_exp) pcexp(`pcexp') tpop(1) rtit(1) ;
tempname mat42tot ;
...
mcjobstat `flist',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(`slist')  stat(share_tot_exp) pcexp(`pcexp') tpop(1) rtit(1)  ;
cap drop `drlist';
tempname mat42 ;
matrix `mat42'= e(est);
