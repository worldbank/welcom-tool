...
mcjobstat `tot_imp',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(total)  stat(exp_pc) tpop(1) rtit(1) ;
tempname mat42tot ;
...
cap drop  __imwmc;
mcjobstat `tot_imp',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(total)  stat(exp_pcs) tpop(1) rtit(1) ;
tempname mat42tot ;
matrix `mat42tot'= e(est); 
};
...
mcjobstat `flist',   hs(`hsize') hgroup(`hgroup') lan(`lan')   xrnames(`slist')  stat(exp_pcs) tpop(1) rtit(1);
cap drop `drlist';
tempname mat42 ;
matrix `mat42'= e(est);
