...
capture program drop lmcjobentropy;
program define lmcjobentropy, eclass;
version 9.2;
...
basicentropy `pcexp' `pcexp',  hsize(`_ths')  theta(`theta') ;
...
basicentropy `sliving' `pcexp',  hsize(`_ths') theta(`theta');
