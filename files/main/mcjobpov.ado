...
capture program drop mcjobpov;
program define mcjobpov, eclass;
version 9.2;
...
basicpov `asliving' ,  hsize(`_ths') pline(`pline') alpha(`alpha') apcexp(`pcexp');
};
if (`move'==-1)     {; 
tempvar sliving asliving osliving;
qui gen `sliving' = `pcexp'+`total';
...
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
gen `osliving' = `asliving' ;
basicpov `pcexp' ,  hsize(`_ths') pline(`pline') alpha(`alpha') apcexp(`asliving');
};
...
qui gen `asliving' = `sliving';
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
if (`move'== 1)   basicpov `asliving' ,  hsize(`_ths') pline(`pline')  alpha(`alpha') apcexp(`osliving');
if (`move'==-1)   basicpov `asliving' ,  hsize(`_ths') pline(`pline')  alpha(`alpha') apcexp(`pcexp');
...
qui gen `asliving' = `sliving';
if ("`aehs'" ~= "" ) qui replace `asliving' = `sliving'*`_ths'/`aehs' ;
basicpov `pcexp' ,  hsize(`_ths') pline(`pline') alpha(`alpha') apcexp(`osliving');
};
