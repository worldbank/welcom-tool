...
#delimit;
capture program drop prjob61;
program define prjob61, eclass;
version 9.2;
...
prjobgini `tot_imp',   hs(`hsize') aehs(`aehs')  lan(`lan')   xrnames(`slist')  pcexp(`pcexp')    ;
tempname mat61tot ;
...
prjobgini `flist',   hs(`hsize') aehs(`aehs')  lan(`lan')   xrnames(`slist')  pcexp(`pcexp')    ;
